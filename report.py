...
class reportClass:
	def __init__(self,root):
		...
		btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.search).place(x=680,y=100,width=100,height=35)
		btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.clear).place(x=800,y=100,width=100,height=35)
		...
		btn_delete=Button(self.root,text='Delete',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.delete).place(x=500,y=350,width=150,height=35)
