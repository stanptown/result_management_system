...
class studentClass:
	def __init__(self,root):
		...
		txt_state=Entry(self.root,textvariable=self.var_state,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=150,width=150,y=220)
		lbl_city=Label(self.root,text="City",font=("goudy old style",15,"bold"),bg='white').place(x=310,y=220)
		txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=380,width=100,y=220)
		
		lbl_pin=Label(self.root,text="Pin",font=("goudy old style",15,"bold"),bg='white').place(x=500,y=220)
		txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=560,width=120,y=220)
		...
		self.txt_roll.place(x=150,width=200,y=60)
		txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=150,width=200,y=100)
		txt_email=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=150,width=200,y=140)
		...
		self.txt_gender.place(x=150,width=200,y=180)
		...
		self.txt_dob.place(x=480,width=200,y=60)
		txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=480,width=200,y=100)
		txt_admission=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=480,width=200,y=140)
		...
		self.txt_course.place(x=480,width=200,y=180)
		...
		#========Buttons==============
		self.btn_add=Button(self.root,text='Save',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.add)
		self.btn_add.place(x=150,y=400,width=110,height=40)
		self.btn_update=Button(self.root,text='Update',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.update)
		self.btn_update.place(x=270,y=400,width=110,height=40)
		self.btn_delete=Button(self.root,text='Delete',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.delete)
		self.btn_delete.place(x=390,y=400,width=110,height=40)
		self.btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.clear)
		self.btn_clear.place(x=510,y=400,width=110,height=40)

		#======= Search panel=====
		self.var_search=StringVar()
		lbl_search_roll=Label(self.root,text="Roll No.",font=("goudy old style",15,"bold"),bg='white').place(x=720,y=60)
		txt_search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,"bold"),bg='lightyellow').place(x=870,width=180,y=60)
		btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg='#0b5337',fg="black",cursor="hand2",highlightbackground="#3E4149",command=self.search).place(x=1060,y=60,width=120,height=30)
